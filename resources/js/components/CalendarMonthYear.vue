...
const formatter = useDateFormatter('es-VE');
</script>
    ...
    <CalendarHeader>
      <CalendarHeading class="flex w-full items-center justify-between gap-2">
        <Select
          ...
          "
        >
          <SelectTrigger aria-label="Seleccione mes" class="w-[60%]">
        ...
        <Select
          ...
          "
        >
          <SelectTrigger aria-label="Seleccione año" class="w-[40%]">
            <SelectValue placeholder="Seleccione año" />
          </SelectTrigger>
          <SelectContent class="max-h-[200px]">
            <SelectItem
              v-for="yearValue in createDecade({ dateObj: date, startIndex: -10, endIndex: 0 })"
