...
<template>
    <AuthBase title="Crear cuenta de usuario" description="Ingrese sus datos a continuación para crear su cuenta">
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="email" type="email" required :tabindex="2" autocomplete="email" v-model="form.email" placeholder="micorreo@ejemplo.com" />
