...
{
    /**
     * Obtiene los detalles del agente de usuario.
     * @param string $ua
     * @return array
     */
    public static function details(string $ua)
    {
        // Enumerate all common platforms, this is usually placed in braces (order is important! First come first serve..)
        $platforms = 'Windows|iPad|iPhone|Macintosh|Linux; Android|BlackBerry|Unix|Linux|CrOS|Ubuntu|Kubuntu|Arch Linux|CentOS|Slackware|Gentoo|openSUSE|SUSE|Red Hat|Fedora|PCLinuxOS|Mageia|(?:Free|Open|Net|\b)BSD';
